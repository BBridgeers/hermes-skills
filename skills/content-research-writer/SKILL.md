...
- Building ROI/business case documents — see [references/roi-briefing-template.md](references/roi-briefing-template.md) for the 8-section McKinsey-style structure with break-even math, industry projection tables, and cited-source appendix
