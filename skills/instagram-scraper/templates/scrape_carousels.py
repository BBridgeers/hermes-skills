#!/usr/bin/env python3
"""Instagram carousel scraper — GraphQL + OCR. Parameterize ACCOUNT and USER_ID."""
...
print(f"Starting scrape for @{ACCOUNT}...", flush=True)
...
failed = 0
print(f"\n--- OCR on {len(carousels)} carousels ---", flush=True)
