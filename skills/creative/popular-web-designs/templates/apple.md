...
### Interactive
- **Apple Blue** (`#0071e3`): `--sk-REDACTED-color`, primary CTA backgrounds, focus rings. The ONLY chromatic color in the interface.
...
- Focus: `2px solid var(--sk-REDACTED-color, #0071E3)` outline
...
- Focus: `2px solid var(--sk-REDACTED-color, #0071e3)` outline, white bg, black text
